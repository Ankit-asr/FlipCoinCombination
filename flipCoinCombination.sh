...
flipdictionary["HH%"]=`echo "scale=2; ${flipdictionary["HH"]} / $fliptimes * 100" |awk -F. '{print $1 "%"}'`  #Determine doublet percentage,display integral part
flipdictionary["HT%"]=`echo "scale=2; ${flipdictionary["HT"]} / $fliptimes * 100" |awk -F. '{print $1 "%"}'`
flipdictionary["TH%"]=`echo "scale=2; ${flipdictionary["TH"]} / $fliptimes * 100" |awk -F. '{print $1 "%"}'`
flipdictionary["TT%"]=`echo "scale=2; ${flipdictionary["TT"]} / $fliptimes * 100" |awk -F. '{print $1 "%"}'`
